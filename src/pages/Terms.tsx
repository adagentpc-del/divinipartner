...
export default function Terms() {
  return (
    <div style={{ maxWidth: 820, margin: '0 auto', padding: '48px 24px 80px', lineHeight: 1.7, color: '#1c2b25' }}>
      ...
      <h2 style={h2}>1. What Divini Partners is, and what it is not</h2>
      <p>
        Divini Partners is a lead-generation, discovery, and networking technology platform that
        helps clients, venues, vendors, planners, and other event professionals find each other and
        coordinate event work. Divini Partners provides software tools and a marketplace venue. We
        are <strong>not</strong> a party to, and are <strong>not</strong> responsible for, any
        agreement, booking, quote, invoice, engagement, or transaction entered into between users.
      </p>
      <p>You acknowledge and agree that Divini Partners is not, and does not act as:</p>
      <ul>
        <li>a broker, agent, representative, employer, contractor, partner, joint venturer, or fiduciary of any user;</li>
        <li>a provider of the event, venue, vendor, planning, or related services listed or arranged through the Platform;</li>
        <li>an escrow agent, bank, money transmitter, trustee, collection agency, or insurer; or</li>
        <li>a guarantor or endorser of any user, listing, profile, service, price, quote, availability, credential, or outcome.</li>
      </ul>
      <p>
        We do not control and are not responsible for the conduct, performance, quality, safety,
        timeliness, legality, or completion of any service, or for any user's honesty, identity,
        qualifications, licensing, insurance, or ability to pay or perform. Any decision to engage,
        hire, book, pay, or work with another user is made solely at your own discretion and risk.
      </p>

      <h2 style={h2}>2. Payments are processed by third parties</h2>
      <p>
        Payments made through the Platform are processed by one or more independent third-party
        payment processors. Your use of those services is governed by the
        applicable processor's own terms and privacy policies. Divini Partners does not take
        custody of, hold, or control transaction funds as principal, and does not provide banking,
        escrow, or money-transmission services.
      </p>
      <p>
        ...
        and payment disputes are governed by the agreement between the transacting users and the
        applicable processor's policies, not by Divini Partners.
      </p>
      ...
      <p>
        ...
        limited to disputes over services, quality, scope, cancellations, no-shows, deposits,
        refunds, payments, property damage, personal injury, or breach of an agreement between
        users, is solely between those users. Divini Partners is not a party to such disputes and
        has no obligation to investigate, mediate, arbitrate, resolve, refund, or otherwise become
        involved. We may, at our sole discretion and without assuming any duty, provide optional
        tools or information to help users communicate, but doing so does not make us a party to or
        responsible for any user dealing.
      </p>
      <p>
        To the fullest extent permitted by law, you release Divini Partners, its affiliates, and
      ...
      <ul>
        ...
        <li>Comply with all applicable laws, licensing, permitting, tax, and insurance requirements for your business and services.</li>
      ...
      <p>
        ...
        introductions, bookings, revenue, or results will be obtained. Any reliance on the Platform
        or on other users is at your own risk.
      </p>

      <h2 style={h2}>6. Limitation of liability</h2>
      <p>
        To the fullest extent permitted by law, Divini Partners and its affiliates, and their
      ...
      <p>
        ...
        greater of (a) the total platform fees you actually paid to Divini Partners in the twelve
      ...
      <p>
        You agree to defend, indemnify, and hold harmless Divini Partners and its affiliates and
      ...
      <p>
        You retain ownership of the content you upload. You grant Divini Partners a limited,
      ...
      <p>
        ...
        of laws rules. Before filing any claim against Divini Partners, you agree to first contact us
        and attempt in good faith to resolve the matter informally. Any dispute between you and
        Divini Partners that is not resolved informally will be brought exclusively in the state or
        federal courts located in Florida, and you consent to their jurisdiction, except where
        binding arbitration applies. To the extent permitted by law, you and Divini Partners each
      ...
      <p>
        ...
        signup, are the entire agreement between you and Divini Partners regarding the Platform.
      </p>
