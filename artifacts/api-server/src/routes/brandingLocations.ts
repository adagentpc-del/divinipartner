...
const LocationBody = z.object({
  ...
  unitRate: z.union([z.number(), z.string(), z.null()]).optional().transform((v) => v == null ? v : String(v)),
  ...
  minCharge: z.union([z.number(), z.string(), z.null()]).optional().transform((v) => v == null ? v : String(v)),
